...
func (ref *RestClient) Get(ctx ctx.Context, path string, inputDTO interface{}, headerRaws ...HeaderRaw) (*http.Response, error) {
	return ref.doRequest(ctx, http.MethodGet, path, nil, inputDTO, headerRaws...)
}

func (ref *RestClient) Post(ctx ctx.Context, path string, outputDTO, inputDTO interface{}, headerRaws ...HeaderRaw) (*http.Response, error) {
	return ref.doRequest(ctx, http.MethodPost, path, outputDTO, inputDTO, headerRaws...)
}

func (ref *RestClient) Put(ctx ctx.Context, path string, outputDTO, inputDTO interface{}, headerRaws ...HeaderRaw) (*http.Response, error) {
	return ref.doRequest(ctx, http.MethodPut, path, outputDTO, inputDTO, headerRaws...)
}

func (ref *RestClient) Delete(ctx ctx.Context, path string, outputDTO, inputDTO interface{}, headerRaws ...HeaderRaw) (*http.Response, error) {
...
func (ref *RestClient) GetFile(ctx ctx.Context, path string, headerRaws ...HeaderRaw) (*http.Response, error) {
	return ref.mPartClient.GetFile(ctx, path, headerRaws...)
}

func (ref *RestClient) doRequest(ctx ctx.Context, method, path string, outputDTO, inputDTO interface{}, headerRaws ...HeaderRaw) (*http.Response, error) {
	var body io.Reader
